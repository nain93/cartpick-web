	...
	return (
		<>
			...
			<Container>
				...
				<br /><br />
				이에 해명할 기회가 있었는데 정확하게 해명하지 않고 계속 거짓된 회피를 하려는 방식으로 문제를 해결하는 미성숙한 대처를 한 점에 사과드립니다. 지속적으로 미숙한 팀의 대응이 상황을 악화시켜 정리 후 말씀드리기 위해 방을 폭파시켰지만 그전에 정확한 공지와 사후 조치를 말씀드리지 않은 점 죄송합니다. 팀 내에서 일어난 모든 일에 대한 책임은 대표인 제가 지겠습니다.<br />
				<br /><br />
				많은 분들이 우려하시는 개인정보데이터가 공유된 해당 사이트는 운영을 자체를 중단하였고 데이터 또한 영구적으로 말소했습니다 (아래 사진 첨부). 마케팅에 문제가 되었던 카트픽 sns와 밀링 sns 계정 모두 삭제 처리하였습니다. 홍보했던 모든 커뮤니티의 경우 카트픽 링크를 클릭하시면 사측 사과문을 확인하실 수 있게 조치하였습니다.<br />
				<br /><br />
