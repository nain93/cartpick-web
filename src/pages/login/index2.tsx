			...
			<Container>
					...
					>
						...
						}
						{
							...
							<>
								...
								<img className="icon2" alt="rightIcon" src={rightIcon} onClick={() => { setIntPageStep1(intPageStep1 - 1) }} />
							</>
						}
					</TitleWrap>
				</Header>

				{
					...
					<>
						...
						<button className="button_kakao1">
							<img className="icon0" src={kakaoIcon} style={{ objectFit: "contain" }} width={18} height={16} alt="kakaoIcon" />
							카카오로 시작하기
						</button>
					</>
				}
